...
class _AwesomeAppState extends State<AwesomeApp> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual,
        overlays: []); //hides navigation and status bar making app fullscreen
    return MaterialApp(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int currentitem) {
                          return GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(colors: colors[currentitem % colors.length] as List<Color>),
                                borderRadius: BorderRadius.circular(20),
                                boxShadow: [
                                  new BoxShadow(color: Colors.black54, blurRadius: 3.5, offset: new Offset(1.0, 2.0)),
                                ],
                              ),
                                                ...
                                                children: <Widget>[
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      children: <Widget>[
                                                        Text("$currentitem\43"),
                                                        Text("Popularity", style: TextStyle(fontSize: 12))
                                                      ],
                                                    )),
                                                  ),
                                                  Expanded(
